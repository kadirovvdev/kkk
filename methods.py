...
person1 = Person("Jacke", "18", "Male")
person2 = Person("Anjella", "22", "FeMale")
person3 = Person("Garri", "34", "Male")

group_1 = Group("120-group")

group_1.add_person(person1)
